...
class App extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      developMode : false,
      //wssUrl : "wss://mainnet.infura.io/ws/v3/38c7487a02c74673bb0f1bc2328bc7ec",
      wssUrl : "wss://falling-nameless-brook.bsc.quiknode.pro/e4fca9b59eee4c6ea1a7cc0fdc5c2b21171bf35a/",
      approveToken: '',
      WBNB: '0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c',
      BUSD : '0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56',
      factory: '0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73',
      router: '0x10ED43C718714eb63d5aA57B78B54704E256024E',
      myWallet: '0xfb7d67a8df387d8a39b2358c206ea25de3e63f5d',
      mnemonic : "diesel game sting any limit tide pony betray escape private drop various",
      logHistory: "",
      buyToken : "",
      buyTokenAmount : "0.01",
      buySlippage : "0",
      ...
      <div className="App">
        ...
        <div className="App-body">
          ...
          <form className="buyForm" onSubmit={this.handleBuySubmit}>
            <h4>Buy token:</h4>
            <br></br>
            <a href={this.state.poocoinLink} id="poocoinLink" target="_blank">Poocoin</a><br></br>
            <a href={this.state.pancakeLink}  target="_blank">PancakeSwap</a><br></br><br></br>
            <label>
              Token Address<br></br>
